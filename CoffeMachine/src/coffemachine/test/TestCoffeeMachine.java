...
public class TestCoffeeMachine {
	...
	public void depositCoinTest() {
		...
		machine.newMoeda10();
		machine.setMessageInDisplay(machine.checkAmountOfCoinsValue()
				.toString());
	...
	public void testTeaLemon() {
		...
		teaLemon = new TeaLemon(new Tea());
		assertEquals(expected, i.prepare(teaLemon));
		assertEquals((float) 0.45, teaLemon.price(), 0);
